...
class SizeOptionRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules = [
            "POST" => [
                "name" => "required|unique:size_options",
            ],
            "PUT"  => [
                "name"=> "required|unique:size_options,name,".request()->segment(count(request()->segments()))
            ]
        ];
