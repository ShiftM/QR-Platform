...
class InterestOptionRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            "POST" => [
                ...
                "name" => "required|unique:interest_options",
            ],
            "PUT" => [
                "status_option_id" => "required",
                "name" => "required|unique:interest_options,name,".request()->segment(count(request()->segments())),
            ]
        ];
