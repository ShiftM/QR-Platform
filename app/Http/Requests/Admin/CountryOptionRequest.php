...
class CountryOptionRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            "POST" => [
                ...
                "name" => "required|unique:country_options",
            ],
            "PUT" => [
                "status_option_id" => "required",
                "name" => "required|unique:country_options,name,".request()->segment(count(request()->segments())),
            ]
        ];
