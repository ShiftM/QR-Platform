...
use App\Http\Requests\Admin\SizeOptionRequest;
...
class SizeOptionController extends Controller
{
    ...
    public function __construct(SizeOption $rest)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(SizeOptionRequest $request)
    {
        $data = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(SizeOptionRequest $request, $id)
    {
        $data = $request->all();
