...
use App\Http\Requests\Admin\ColorOptionRequest;
...
class ColorOptionController extends Controller
{
    ...
    public function __construct(ColorOption $rest)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(ColorOptionRequest $request)
    {
        $data = $request->all();
        $data['hex'] = isset($data['hex']) && $data['hex'] ? $data['hex'] : '#000000';
        $callback = function () use ($data) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ColorOptionRequest $request, $id)
    {
        $data = $request->all();
        $data['hex'] = isset($data['hex']) && $data['hex'] ? $data['hex'] : '#000000';
