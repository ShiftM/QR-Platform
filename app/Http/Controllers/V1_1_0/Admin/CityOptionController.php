...
class CityOptionController extends Controller
{
    /**
     * @var RestRepository
     */
    ...
    public function __construct(CityOption $rest)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CityOptionRequest $request)
    {
        $data = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CityOptionRequest $request, $id)
    {
        $data = $request->all();
