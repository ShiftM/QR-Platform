...
use App\Http\Requests\Admin\FeaturedItemRequest;
...
class FeaturedItemController extends Controller {
    ...
    public function __construct(FeaturedItem $rest) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(FeaturedItemRequest $request) {
        //
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(FeaturedItemRequest $request, $id) {
        //
        $data = $request->all();
