...
use App\Http\Requests\Admin\CategoryHeaderRequest;
...
class CategoryHeaderController extends Controller
{
    ...
    public function __construct(CategoryHeader $rest)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(CategoryHeaderRequest $request)
    {
        $data = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(CategoryHeaderRequest $request, $id)
    {
        $data = $request->all();
