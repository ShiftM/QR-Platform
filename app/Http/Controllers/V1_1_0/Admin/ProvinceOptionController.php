...
use App\Http\Requests\Admin\CityOptionRequest;
use App\Http\Requests\Admin\IndexRequest;
use App\Http\Requests\Admin\ProvinceOptionRequest;
use App\ProvinceOption;
use App\Repositories\Rest\RestRepository;
use App\Http\Controllers\Controller;

class ProvinceOptionController extends Controller
{
    /**
     * @var RestRepository
     */
    ...
    public function __construct(ProvinceOption $rest)
    {
    ...
    public function index(IndexRequest $request)
    {
        ...
        $callback = function () use ($data) {
            ...
            if(isset($data['region_option_id'])){
                $response = $response->whereRegionOptionId($data['region_option_id']);
            }
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(ProvinceOptionRequest $request)
    {
        $data = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(ProvinceOptionRequest $request, $id)
    {
        $data = $request->all();
