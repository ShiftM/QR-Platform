...
use App\Http\Requests\Admin\InterestOptionRequest;
...
class InterestOptionController extends Controller
{
    ...
    public function __construct(InterestOption $rest) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(InterestOptionRequest $request) {
        //
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(InterestOptionRequest $request, $id) {
        //
        $data = $request->all();
