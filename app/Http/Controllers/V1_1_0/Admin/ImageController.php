...
class ImageController extends Controller {
	...
	public function __construct(Image $rest) {
	...
	public function destroyByParent($id, $table) {


		$callback = function () use ($id, $table) {

			if ($response = $this->rest->getModel()->whereTableType($table)->whereTableId($id)) {
